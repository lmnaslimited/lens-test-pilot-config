          ...
          primary_action(idValues) {
            ...
            try {
              ...
              if (!LaUniqueFields.length) {
                frappe.msgprint(
                  __("No fields found in the provided modal HTML.")
                );
                return;
              }
              ...
              if (!LaNewFields.length) {
                frappe.msgprint({
                  title: "Info",
                  message: __(
                    "All extracted fields already exist in json_response."
                  ),
                  indicator: "blue",
                });
              ...
              frappe.msgprint({
                title: "Success",
                message: __(
                  `${LaNewFields.length} modal fields extracted successfully.`
                ),
                indicator: "green",
              });
